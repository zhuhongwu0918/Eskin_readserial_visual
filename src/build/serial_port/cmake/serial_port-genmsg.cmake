...
message(STATUS "serial_port: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iserial_port:/home/abc/catkin_ws/src/serial_port/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/abc/catkin_ws/src/serial_port/msg/contactpoint.msg" NAME_WE)
add_custom_target(_serial_port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_port" "/home/abc/catkin_ws/src/serial_port/msg/contactpoint.msg" ""
)
...
_generate_msg_cpp(serial_port
  "/home/abc/catkin_ws/src/serial_port/msg/contactpoint.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_port)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_port\")")
  # install generated code
  install(
