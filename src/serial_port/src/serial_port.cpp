...
// #include "../serial_port/include/serial_port.h"
#include "/home/abc/catkin_ws/src/serial_port/include/serial_port/serial_port.h"

// void serialData::decode_ok(unsigned char *pData, unsigned short len)
// {
//     sd->pubSensorInfo=n.advertise<serial_port::contactpoint>("/sensorInfo",100);//这个将作为话题名

// }
// std_msgs::String output;
serial_port::contactpoint tactilepoint;
// output.data = "global";
...
void decode_ok(unsigned char *pData, unsigned short len)
{
    ...
    // serial_port::contactpoint point;
    // point.point1x = 1;
